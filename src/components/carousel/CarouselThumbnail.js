    ...
    <RootStyle>
      ...
      <Box
        sx={{
          mt: 3,
          mx: "auto",
          ...([].length === 1 && { maxWidth: THUMB_SIZE * 1 + 16 }),
          ...([].length === 2 && { maxWidth: THUMB_SIZE * 2 + 32 }),
          ...([].length === 3 && { maxWidth: THUMB_SIZE * 3 + 48 }),
          ...([].length === 4 && { maxWidth: THUMB_SIZE * 3 + 48 }),
          ...([].length === 5 && { maxWidth: THUMB_SIZE * 6 }),
          "& .slick-current img": {
            opacity: 1,
